...
export default function UpdateCourse() {
    ...
    const handleSubmit = () => {
        ...
        axios.put(`${host}/api/admin/updatecourse/${id}`, Data)
            .then((res) => {
                if (res.data) {
                    console.log(res.data,'respone')
                    setOpen(true);
                    setTimeout(async()=>{
                        await nav('/admin/manage-course');
            ...
            <Paper>
                ...
                <Grid container spacing={2} sx={{ p: 2 }}>
                    <Grid item xs={12} md={3}>
                        <TextField id="outlined-basic" InputLabelProps={{ shrink: 'none' }} label="Title" name='title' onChange={handleCourseDetails} value={courseDetails.title} variant="outlined" size="small" fullWidth />
                    </Grid>
                    <Grid item xs={12} md={3}>
                        <TextField id="outlined-basic" InputLabelProps={{ shrink: 'none' }} label="Category" name='category' onChange={handleCourseDetails} value={courseDetails.category} variant="outlined" size="small" fullWidth />
                    </Grid>
                    <Grid item xs={12} md={3}>
                        <TextField id="outlined-basic" InputLabelProps={{ shrink: 'none' }} label="Level" name='level' onChange={handleCourseDetails} value={courseDetails.level} variant="outlined" size="small" fullWidth />
                    </Grid>
                    <Grid item xs={12} md={3}>
                    ...
                    <Grid item xs={12}>
                        <TextField id="outlined-basic" label="Description" InputLabelProps={{ shrink: 'none' }} name='description' onChange={handleCourseDetails} value={courseDetails.description} variant="outlined" size="small" multiline rows={2} fullWidth />
                    </Grid>
